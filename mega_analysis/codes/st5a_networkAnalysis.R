...
genes = read.delim("./results/tables/intersect_genes.tsv",header = F)

#### keep only intersect genes
datExpr = datExp.comb[genes$V1,]
rm(datExp,datExp.comb)
...
save(file = "./codes/Combined_for_network.Rdata",allMeta,datExpr)
